...
Los `<img>` de `.fragata-hero` y `.fragata-reel` SHALL declarar `srcset` con variantes de 480w, 900w, 1400w y el archivo original, más un `sizes` que refleje el ancho real renderizado de cada grupo (no `100vw`, ya que ninguno es full-bleed).

# luna-taruma-quiz-game Specification

## Purpose
Definir el juego "Florecé el Tarumá" embebido en la sección del evento: recorrido de diez preguntas sobre la Luna, el río y la Selva Marginal, escena que florece con el progreso, resultado que invita a las noches, y el aislamiento de sus estilos, identificadores y alcance de JavaScript respecto del resto de la página.
## Requirements

...
`index.html` SHALL incluir una sección del evento con un encabezado accesible (`aria-labelledby`) y cinco partes: el relato del evento, la agenda de noches, la galería de imágenes, la convocatoria a artistas y los créditos de organización.

#### Scenario: Estructura de la sección

- **WHEN** se inspecciona la sección del evento
- **THEN** contiene el relato, la agenda, la galería, la convocatoria y los créditos, y su encabezado está referenciado por `aria-labelledby`

...
## Corpus Check
- 275 files · ~310,759 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3746 nodes · 7186 edges · 298 communities (259 shown, 39 thin omitted)
...
## Communities (298 total, 39 thin omitted)
...
Cohesion: 0.06
Nodes (45): checkPageTypography(), resolveSerif(), CSS_IN_JS_EXTENSIONS, extFromFilePath(), extractCSSinJS(), extractStyleBlocks(), firstOverusedGoogleFont(), isNeutralBorderColor() (+37 more)

### Community 62 - "detect-antipatterns.mjs"
Cohesion: 0.11
Nodes (48): confirm(), detectCli(), formatFindings(), formatFindingSummary(), handleStdin(), printUsage(), createBrowserDetector(), detectUrl() (+40 more)
...
### Community 297 - "tasks.md"
Cohesion: 0.50
Nodes (3): 1. Rama y preparación, 2. Corregir el color, 3. Verificación y entrega

## Knowledge Gaps
- **1280 isolated node(s):** `COMMON_DEV_PORTS`, `SOURCE_DIRS`, `PRODUCT_NAMES`, `DESIGN_NAMES`, `FALLBACK_DIRS` (+1275 more)
...
- **Why does `el()` connect `el` to `checks.mjs`, `optimize.md`, `index.mjs`, `setLiveState`, `design-system.mjs`, `Improve Typography Systematically`, `design.md`, `Identidad y sistema visual de marca`, `bolder.md`, `css-cascade.mjs`, `detect-antipatterns-browser.js`, `showToast`, `initGlobalBar`, `resolveContext`, `detect-text.mjs`, `detect-antipatterns.mjs`?**
  _High betweenness centrality (0.076) - this node is a cross-community bridge._
- **Why does `v()` connect `modern-screenshot.umd.js` to `bolder.md`, `checkHeroEyebrow`, `Identidad y sistema visual de marca`, `css-cascade.mjs`, `design-parser.mjs`?**

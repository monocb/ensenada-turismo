...
## Corpus Check
- 172 files · ~275,111 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3022 nodes · 6638 edges · 158 communities (154 shown, 4 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 131 edges (avg confidence: 0.68)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b60b2ec4`
...
Cohesion: 0.10
Nodes (47): resolveVarRefs(), ae(), be(), bt(), Ce(), de(), dt(), _e() (+39 more)
...
Cohesion: 0.07
Nodes (43): checkBorders(), checkClippedOverflow(), checkElementBorders(), checkElementBordersDOM(), checkElementClippedOverflow(), checkElementClippedOverflowDOM(), checkElementHeroEyebrow(), checkElementHeroEyebrowDOM() (+35 more)
...
Cohesion: 0.10
Nodes (38): appendOriginToDirective(), buildTagBlock(), commentClose(), commentOpen(), CONFIG_PATH, detectLineEnding(), __dirname, ensureLiveGitIgnores() (+30 more)
...
Cohesion: 0.09
Nodes (31): assembleLiveBrowserScript(), assertLiveBrowserScriptParts(), LIVE_BROWSER_SCRIPT_PARTS, readLiveBrowserScriptParts(), resolveLiveBrowserScriptParts(), activeSessionSummaries(), agentPollingConnected(), annotRoot (+23 more)
...
Cohesion: 0.11
Nodes (24): CSS_IN_JS_EXTENSIONS, detectText(), extFromFilePath(), extractCSSinJS(), extractStyleBlocks(), firstOverusedGoogleFont(), isNeutralBorderColor(), PAGE_ANALYZER_EXTS (+16 more)
...
Cohesion: 0.12
Nodes (13): Assess Adaptation Challenge, Implement & Verify, Assess Animation Opportunities, Plan Animation Strategy, Register, Verify Quality, 1. Accessibility (VoiceOver / TalkBack), 2. Performance (+5 more)
...
## Knowledge Gaps
- **768 isolated node(s):** `Setup`, `Color`, `Typography`, `Layout`, `Motion` (+763 more)
...
- **Why does `el()` connect `el` to `checks.mjs`, `index.mjs`, `setLiveState`, `design-system.mjs`, `Identidad y sistema visual de marca`, `collectBrowserFindings`, `GENERIC_FONTS`, `css-cascade.mjs`, `detect-antipatterns-browser.js`, `showToast`, `detect-html.mjs`, `refreshParamsPanel`, `initGlobalBar`, `checkElementDesignSystemDOM`, `checkQuality`, `parseRgb`, `parseAnyColor`?**
  _High betweenness centrality (0.074) - this node is a cross-community bridge._
- **Why does `v()` connect `modern-screenshot.umd.js` to `checks.mjs`, `Identidad y sistema visual de marca`, `context-signals.mjs`, `refreshParamsPanel`, `design-parser.mjs`?**

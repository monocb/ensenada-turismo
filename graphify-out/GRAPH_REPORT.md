...
## Corpus Check
- 255 files · ~304,369 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3619 nodes · 7079 edges · 280 communities (241 shown, 39 thin omitted)
...
- tasks.md
- checkHeroEyebrow
- 2026-07-12T23-32-39Z__en-fotos-index-html.md
- ADDED Requirements
- readWorkspacePatterns
- Generate Report
- proposal.md
...
## Communities (280 total, 39 thin omitted)
...
Cohesion: 0.05
Nodes (77): borderColorsFromStyle(), borderWidthsFromStyle(), checkClippedOverflow(), checkCreamPalette(), checkElementClippedOverflow(), checkElementClippedOverflowDOM(), checkElementGptBorderShadow(), checkElementGptBorderShadowDOM() (+69 more)
...
Cohesion: 0.06
Nodes (32): CSS Anchor Positioning, Destructive Actions: Undo > Confirm, Dropdown & Overlay Positioning, Fixed Positioning Fallback, Focus Rings: Do Them Right, Form Design: The Non-Obvious, Gesture Discoverability, Interaction Design (+24 more)
...
Cohesion: 0.09
Nodes (20): Assess Adaptation Challenge, Implement & Verify, Android platform, Color & theming, Components & motion, Layout & structure, The Android slop test, Touch targets (+12 more)
...
### Community 224 - "2026-07-12T23-32-39Z__en-fotos-index-html.md"
Cohesion: 0.22
Nodes (8): Anti-Patterns Verdict, Design Health Score, Minor Observations, Overall Impression, Persona Red Flags, Priority Issues, Questions to Consider, What's Working

### Community 225 - "ADDED Requirements"
Cohesion: 0.22
...
### Community 226 - "readWorkspacePatterns"
Cohesion: 0.32
...
### Community 235 - "Adaptation Strategies"
Cohesion: 0.40
...
### Community 236 - "4. Plan three variants: identity first, then mode, then axes"
Cohesion: 0.40
...
### Community 237 - "Requirement: El eyebrow de la página 404 renderiza en el color dorado de marca"
Cohesion: 0.40
...
### Community 238 - "Requirement: 404.html carga la tipografía Inter"
Cohesion: 0.40
...
### Community 240 - "Metodología: OpenSpec"
Cohesion: 0.67
Nodes (3): Flujo, Metodología: OpenSpec, Ver también

## Knowledge Gaps
- **1200 isolated node(s):** `COMMON_DEV_PORTS`, `SOURCE_DIRS`, `PRODUCT_NAMES`, `DESIGN_NAMES`, `FALLBACK_DIRS` (+1195 more)
...
- **Why does `el()` connect `el` to `typeset.md`, `checks.mjs`, `index.mjs`, `setLiveState`, `design-system.mjs`, `Improve Typography Systematically`, `Identidad y sistema visual de marca`, `README.md`, `bolder.md`, `css-cascade.mjs`, `detect-antipatterns-browser.js`, `showToast`, `_`, `detect-html.mjs`, `initGlobalBar`, `resolveContext`, `detect-text.mjs`, `parseAnyColor`?**
  _High betweenness centrality (0.078) - this node is a cross-community bridge._
- **Why does `v()` connect `modern-screenshot.umd.js` to `bolder.md`, `Identidad y sistema visual de marca`, `css-cascade.mjs`, `context-signals.mjs`, `Phase 1: Discovery Interview`, `design-parser.mjs`?**

...
## Corpus Check
- 64 files · ~22,683 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 315 nodes · 383 edges · 27 communities (26 shown, 1 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 16 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0642396b`
...
Cohesion: 0.08
Nodes (23): Seguridad, Contenido de la home, Identidad y navegación, Secciones de la home, Ver también, Concurso de microrelatos "Historias de Ensenada", Concurso fotográfico, Funcionalidades futuras (+15 more)
...
Cohesion: 0.09
Nodes (19): Índice de documentación — Turismo Ensenada, Convenciones de CSS, `styles.css` creció por parches, no por diseño de arquitectura, Convenciones de JS, Metodología: Graphify, Salida, Uso día a día, Ver también (+11 more)
...
## Knowledge Gaps
- **164 isolated node(s):** `Context`, `Goals / Non-Goals`, `Decisions`, `Risks / Trade-offs`, `Migration Plan` (+159 more)

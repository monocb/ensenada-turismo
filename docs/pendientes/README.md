...
Estado conocido de bugs y deuda técnica — no asumir que algo funciona o que falta sin verificar primero. Cada archivo es un caso de uso atómico — un tema puntual, autocontenido.

| Caso de uso | Contenido |
|---|---|
| [`bug-portada-mobile.md`](bug-portada-mobile.md) | Imagen de fondo del hero mal posicionada en celular |
...
| [`performance.md`](performance.md) | Imágenes sin optimizar, falta lazy loading/srcset |
| [`seguridad.md`](seguridad.md) | Superficie de riesgo actual y qué cuidar si se agregan formularios |
